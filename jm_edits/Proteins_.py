...
def get_single_node_neighbors_distributions(Gk, G, node, direction="successors"):
    ...
    #         neighbors = Gk.inNeighbors(node)
    #     else:  # successors
    #         neighbors = Gk.neighbors(node)
    # else:
    #     neighbors = Gk.neighbors(node)
...
def xyd(Gk, G, source, target):
    
    x,source_topknbr = get_single_node_neighbors_distributions(Gk, G, source, direction="successors")
    y,target_topknbr = get_single_node_neighbors_distributions(Gk, G, target, direction="successors")
...
def path_pd_all_w(G1, G, path):
    ...
    for ii in range(len(path_new)):
        # path_new[ii].insert(4, 'op_edge', 'nan')
        # path_new[ii].insert(5, 'op_c0', 'nan')
        # path_new[ii].insert(6, 'op_c1', 'nan')
        # path_new[ii].insert(7, 'op_c0-c1', 'nan')
        #
        # path_new[ii].insert(8, 'sp_edge', 'nan')
        # path_new[ii].insert(9, 'sp_c0', 'nan')
        # path_new[ii].insert(10, 'sp_c1', 'nan')
        # path_new[ii].insert(11, 'sp_c0-c1', 'nan')
...
#     a,b,c,d = find_symmetric_point_and_plane_chiral(xyz, G, orn, ore)
    ...
    for ii in range(len(m_point)):
        S = np.sum(np.isclose(np.vstack(node_vec['direction']),np.round(np.asarray(m_point)[ii],3), atol=1), axis=1)
